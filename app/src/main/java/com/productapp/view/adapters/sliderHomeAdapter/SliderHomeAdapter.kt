package com.productapp.view.adapters.sliderHomeAdapter
...
class SliderHomeAdapter(image: List<Int>) : SliderViewAdapter<SliderHomeAdapter.SliderViewHolder>() {

    private var sliderImage: List<Int> = image
